module.exports = {
    ...
    SHOP_LENTA: (params) => `select sl.*,(select count(*) from lenta_like ll where ll.shop_lenta_id=sl.id) as likeCount from shop_lenta sl where  sl.verify=1  and sl.shop_id=${params.shop_id}  limit ${params.offset}, ${params.limit};`,
    ...
    GET_SHOPS_FOR_FILTER:'select id,shop_name,photo from shop'
}
